...
const ScrollStack: React.FC<ScrollStackProps> = ({
  ...
  const updateCardTransforms = useCallback(() => {
    ...
    cardsRef.current.forEach((card, i) => {
      ...
      // Usar la posición original guardada en lugar de recalcularla
      ...
      // TODAS las cards tienen el mismo pinEnd para que se muevan juntas
      // Solo se mueven cuando llegamos al final del scroll stack
      ...
      const hasChanged =
        !lastTransform ||
        Math.abs(lastTransform.translateY - newTransform.translateY) > 1.0 ||
  ...
  useLayoutEffect(() => {
    ...
    // Guardar las posiciones originales de cada card (solo una vez)
    originalCardTopsRef.current = cards.map((card) => {
      if (useWindowScroll) {
        // Obtener la posición ORIGINAL sin transforms aplicados
